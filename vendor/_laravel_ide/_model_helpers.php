...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Mahasiswa>|Mahasiswa aktif() {@see App\Models\Mahasiswa::scopeAktif()}
     * @method static \Illuminate\Database\Eloquent\Builder<Mahasiswa>|Mahasiswa angkatan(int $t) {@see App\Models\Mahasiswa::scopeAngkatan()}
     * @method static \Illuminate\Database\Eloquent\Builder<Mahasiswa>|Mahasiswa dariProdi(int $id) {@see App\Models\Mahasiswa::scopeDariProdi()}
     * @method static \Illuminate\Database\Eloquent\Builder<Mahasiswa>|Mahasiswa cari(string $kw) {@see App\Models\Mahasiswa::scopeCari()}
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Mahasiswa>|Mahasiswa timeout(int $seconds)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Nilai>|Nilai semester(string $semester) {@see App\Models\Nilai::scopeSemester()}
     * @method static \Illuminate\Database\Eloquent\Builder<Nilai>|Nilai tahunAkademik(int $tahun) {@see App\Models\Nilai::scopeTahunAkademik()}
     * @method static \Illuminate\Database\Eloquent\Builder<Nilai>|Nilai lulus() {@see App\Models\Nilai::scopeLulus()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<Nilai>|Nilai timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<Prodi>|Prodi timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
